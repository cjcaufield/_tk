...
<div class="jumbotron tight-jumbotron jumbotron-black home-page-image-jumbotron">
	<div class="jumbo-image-div">
		<img src="/wp-content/uploads/squattersreversed.jpg" width="100%" height="auto" border="0" />
		<div class="jumbo-image-centering-table-wrapper dark-green-overlay">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
				<!--
				<div class="home-page-logo-outer-div">
...
<div class="jumbotron big-vertical-padding">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="text-center">
					<h2>Some slightly smaller text.</h2>
				</div>
			</div>
		</div>
	</div>
